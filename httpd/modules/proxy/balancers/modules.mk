...
mod_lbmethod_ai.la: mod_lbmethod_ai.slo
	$(SH_LINK) -rpath $(libexecdir) -module -avoid-version  mod_lbmethod_ai.lo $(MOD_LBMETHOD_AI_LDADD)
DISTCLEAN_TARGETS = modules.mk
static = 
shared =  mod_lbmethod_byrequests.la mod_lbmethod_bytraffic.la mod_lbmethod_bybusyness.la mod_lbmethod_heartbeat.la mod_lbmethod_ai.la

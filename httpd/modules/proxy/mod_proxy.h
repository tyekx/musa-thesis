...
#if DEBUG_PROXY == 1
    #define PDLOG(...) ap_log_error(APLOG_MARK, APLOG_NOTICE, 0, NULL, __VA_ARGS__)
    #define PPLOG(ptr) if(ptr) { ap_log_error(APLOG_MARK, APLOG_NOTICE, 0, NULL, #ptr " is not null."); } \
					   else { ap_log_error(APLOG_MARK, APLOG_NOTICE, 0, NULL, #ptr " is null."); }
#else
    #define PDLOG(...)
#endif

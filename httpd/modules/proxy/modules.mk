...
mod_ai.la: mod_ai.slo
	$(SH_LINK) -rpath $(libexecdir) -module -avoid-version  mod_ai.lo $(MOD_AI_LDADD)
...
static = 
shared =  mod_proxy.la mod_ai.la mod_proxy_connect.la mod_proxy_ftp.la mod_proxy_http.la mod_proxy_fcgi.la mod_proxy_scgi.la mod_proxy_uwsgi.la mod_proxy_fdpass.la mod_proxy_wstunnel.la mod_proxy_ajp.la mod_proxy_balancer.la mod_proxy_express.la mod_proxy_hcheck.la
